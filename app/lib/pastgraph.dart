...
class PastGraphScreen extends StatefulWidget {
  const PastGraphScreen({super.key, required this.selectedTime});
  final TimeOfDay selectedTime; // 선택한 시간을 받을 변수

  @override
  PastGraphScreenState createState() => PastGraphScreenState();
}

class PastGraphScreenState extends State<PastGraphScreen> {
  // 입력받을 변수들 선언
